ARG IMAGE=python:3.14-alpine3.22@sha256:6b91e66ab2a880ce9ca5a1b91c70f45963ff71ff68268df056336e1a657d5efd
...
https://github.com/kamaradclimber/heishamon-homeassistant/archive/refs/tags/2.10.1.tar.gz|\
https://github.com/mampfes/hacs_waste_collection_schedule/archive/refs/tags/v2.34.2.tar.gz"
ARG FRONTEND_MODULES="\
https://github.com/custom-cards/button-card/releases/download/v7.0.1/button-card.js|\
https://github.com/NemesisRE/kiosk-mode/releases/download/v14.2.0/kiosk-mode-es5.js|\
...
ENV HASS_VERSION="2026.9.3"
# https://www.home-assistant.io/integrations/default_config/
# REMOVED: dhcp, bluetooth, zeroconf (makes no sense without hostnetwork/usb)
# ADDED: tts, ffmpeg
ENV MINIMAL_COMPONENTS="generic|frontend|assist_pipeline|backup|config|conversation|energy|go2rtc|history|homeassistant_alerts|cloud|image_upload|logbook|media_source|mobile_app|my|ssdp|stream|sun|usb|webhook|isal|otp|tts|ffmpeg|hassio"
...
COPY --link --from=ghcr.io/alexxit/go2rtc:1.9.14@sha256:675c318b23c06fd862a61d262240c9a63436b4050d177ffc68a32710d9e05bae /usr/local/bin/go2rtc /usr/local/bin/go2rtc
