...
https://github.com/kamaradclimber/heishamon-homeassistant/archive/refs/tags/2.6.0.tar.gz|\
https://github.com/mampfes/hacs_waste_collection_schedule/archive/refs/tags/v2.26.0.tar.gz"

# renovate: datasource=pypi depName=homeassistant versioning=loose
ENV HASS_VERSION="2026.6.0"
