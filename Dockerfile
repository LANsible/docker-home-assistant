...
https://github.com/kamaradclimber/heishamon-homeassistant/archive/refs/tags/2.6.3.tar.gz|\
https://github.com/mampfes/hacs_waste_collection_schedule/archive/refs/tags/v2.32.0.tar.gz"
ARG FRONTEND_MODULES="\
https://github.com/custom-cards/button-card/releases/download/v7.0.1/button-card.js|\
https://github.com/NemesisRE/kiosk-mode/releases/download/v14.0.2/kiosk-mode-es5.js|\
