...
https://github.com/kamaradclimber/heishamon-homeassistant/archive/refs/tags/2.7.1.tar.gz|\
https://github.com/mampfes/hacs_waste_collection_schedule/archive/refs/tags/v2.34.1.tar.gz"
